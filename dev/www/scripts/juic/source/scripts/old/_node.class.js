...
TNT.Juic.Core.Node = TNT.declareClass({
  ...
  set : function(name, value) {
    ...
    if (split) {
      ...
      if (content && content instanceof TNT.Juic.Core.Object) { 
        return content.set(split[1], value);
      }
      throw 'Unknown content: ' + split[0];
      return;
    }

    return TNT.Juic.Core.Object.prototype.set.call(this, name, value);
  },
  ...
  get : function(name, value) {
    ...
    if (split) {
      var content = this.contentByPath(split[0]);
      if (content && content instanceof TNT.Juic.Core.Object) { 
        return content.get(split[1], value);
      }
      throw 'Unknown content: ' + split[0];
      return;
    }

    return TNT.Juic.Core.Object.prototype.get.call(this, name);
  },
